...
- [x] T012 [P] ConfigMap for environment variables in k8s/configmap.yaml
- [x] T013 [P] Secret management for certificates in k8s/secret.yaml
- [x] T014 [P] PersistentVolume for holotree data in k8s/persistent-volume.yaml
- [x] T015 Kubernetes Deployment with HPA scaling in k8s/deployment.yaml
- [x] T016 Kubernetes Service with stable DNS in k8s/service.yaml
- [x] T017 [P] Ingress configuration for SSL termination in k8s/ingress.yaml
...
- [x] T023 Non-root user security contexts in Dockerfile and manifests
- [x] T024 SSL/TLS enforcement validation in deployment configurations

## Phase 3.6: Deployment Automation
- [x] T025 Kubernetes deployment script in scripts/deploy-k8s.sh
- [x] T026 Docker deployment script in scripts/deploy-docker.sh
- [x] T027 Comprehensive health check script in scripts/health-check.sh
...
- [x] T034 [P] Kubernetes setup instructions in docs/kubernetes-setup.md
- [x] T035 [P] ARC runner integration guide in docs/arc-integration.md
